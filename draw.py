...
def draw_polygons( points, screen, color ):
    ...
    while i < len(points) - 2:
        ve1 = points[i + 1][0] - points[i][0]
        ve2 = points[i + 1][1] - points[i][1]
        ve3 = points[i + 2][0] - points[i][0]
        ve4 = points[i + 2][1] - points[i][1]
        n = ve1 * ve4 - ve2 * ve3
        if n > 0:
